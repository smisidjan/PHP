...
<div>
    <form action="garagebedrijf.php" method="post">
        ...
        <select name="automerk">
            ...
            <option <?php if ($autoMerk == 'Audi') echo 'selected = "selected"'; ?> name="Audi" value="Audi">Audi</option>
            <option <?php if ($autoMerk == 'Ferrari') echo 'selected = "selected"'; ?>name="Ferrari" value="Ferrari">Ferrari</option>
            <option <?php if ($autoMerk == 'Fiat') echo 'selected = "selected"'; ?>name="Fiat" value="Fiat">Fiat</option>
            <option <?php if ($autoMerk == 'Mercedes') echo 'selected = "selected"'; ?>name="Mercedes" value="Mercedes">Mercedes</option>
            <option <?php if ($autoMerk == 'Opel') echo 'selected = "selected"'; ?>name="Opel" value="Opel">Opel</option>
            <option <?php if ($autoMerk == 'Volkswagen') echo 'selected = "selected"'; ?>name="Volkswagen" value="Volkswagen">Volkswagen</option>
        </select>
